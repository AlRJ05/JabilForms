/*!
 * Jabilbootstrap - v4.2.0
 * @author Jabil IT UX/UI Team
 * Copyright (c) 2019
 */
! function(e) {
    var a = {};
            ...
            return a = e, o = [{
                ...
                value: function() {
                    jQuery('[data-toggle="tabs"]:not(.js-tabs-enabled)').add(".js-tabs:not(.js-tabs-enabled)").each(function(e, a) {
                        jQuery(a).addClass("js-tabs-enabled").find("a").on("click.jabilbootstrap.helpers.core", function(e) {
                ...
                key: "coreToggleClass",
                value: function() {
                    jQuery('[data-toggle="class-toggle"]:not(.js-class-toggle-enabled)').add(".js-class-toggle:not(.js-class-toggle-enabled)").on("click.jabilbootstrap.helpers.core", function(e) {
                ...
                key: "coreScrollTo",
                value: function() {
                    jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.jabilbootstrap.helpers.core", function(e) {
                        e.stopPropagation();
                ...
                value: function() {
                    jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function(e, a) {
                        ...
                        t.addClass("js-click-ripple-enabled").css({
                            ...
                            position: "relative",
                            "z-index": 1
                        }).on("click.jabilbootstrap.helpers.core", function(e) {
                            var a, o, n, r;
                ...
                value: function() {
                    jQuery(".js-table-sections:not(.js-table-sections-enabled)").each(function(e, a) {
                        var t = jQuery(a);
                        t.addClass("js-table-sections-enabled"), jQuery(".js-table-sections-header > tr", t).on("click.jabilbootstrap.helpers", function(e) {
                ...
                value: function() {
                    ...
                    jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each(function(a, t) {
                        var o = jQuery(t);
                        o.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", o).on("click.jabilbootstrap.helpers", function(a) {
                        ...
                        }), jQuery("tbody input:checkbox, tbody input + label", o).on("click.jabilbootstrap.helpers", function(a) {
                        ...
                        }), jQuery("tbody > tr", o).on("click.jabilbootstrap.helpers", function(a) {
                ...
                value: function() {
                    ...
                    jQuery.isEmptyObject(e) ? jQuery(".js-notify:not(.js-notify-enabled)").each(function(e, a) {
                        jQuery(a).addClass("js-notify-enabled").on("click.jabilbootstrap.helpers", function(e) {
                            var a = jQuery(e.currentTarget);
                            jQuery.notify({
                                icon: a.data("icon") || "",
    ...
    var c = function() {
        ...
        return a = e, (t = [{
            ...
            key: "_uiHandleNav",
            value: function() {
                this._lPage.off("click.jabilbootstrap.menu"), this._lPage.on("click.jabilbootstrap.menu", '[data-toggle="submenu"]', function(e) {
                    var a = jQuery(e.currentTarget),
                        t = a.parent("li");
            ...
            value: function() {
                ...
                if (a) {
                    var t = Cookies.get("jabilbootstrapThemeName") || !1;
                    t && n.updateTheme(e, t), e = jQuery("#css-theme")
                }
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.jabilbootstrap.themes"), this._lPage.on("click.jabilbootstrap.themes", '[data-toggle="theme"]', function(t) {
                    t.preventDefault();
                    var o = jQuery(t.currentTarget),
                        r = o.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), n.updateTheme(e, r), e = jQuery("#css-theme"), a && Cookies.set("jabilbootstrapThemeName", r, {
                        expires: 7
                    }), o.blur()
                })
            }
            ...
            value: function() {
                ...
                var t = {
                    init: function() {
                        a._lPage.off("click.jabilbootstrap.layout"), a._lPage.off("click.jabilbootstrap.overlay"), a._lPage.on("click.jabilbootstrap.layout", '[data-toggle="layout"]', function(e) {
                            var t = jQuery(e.currentTarget);
                            a._uiApiLayout(t.data("action")), t.blur()
                        }), a._lPage.hasClass("enable-page-overlay") && (a._lPage.prepend('<div id="page-overlay"></div>'), jQuery("#page-overlay").on("click.jabilbootstrap.overlay", function(e) {
                    ...
                    sidebar_style_dark: function() {
                        ...
                        $("img.sidebar-header-img").attr("src", "assets/media/various/jabil-a.svg");
                    },
                    sidebar_style_light: function() {
                        a._lPage.removeClass("sidebar-dark");
                        $("img.sidebar-header-img").attr("src", "assets/media/various/jabil-a-blue.svg");
                    },
                    ...
                    side_overlay_open: function() {
                        jQuery(document).on("keydown.jabilbootstrap.sideOverlay", function(e) {
                            27 === e.which && (e.preventDefault(), a._uiApiLayout("side_overlay_close"))
                        }), a._lPage.addClass("side-overlay-o")
                    },
                    side_overlay_close: function() {
                        jQuery(document).off("keydown.jabilbootstrap.sideOverlay"), a._lPage.removeClass("side-overlay-o")
                    },
                    ...
                    header_search_on: function() {
                        a._lHeaderSearch.addClass("show"), a._lHeaderSearchInput.focus(), jQuery(document).on("keydown.jabilbootstrap.header.search", function(e) {
                            27 === e.which && (e.preventDefault(), a._uiApiLayout("header_search_off"))
                        })
                    },
                    header_search_off: function() {
                        a._lHeaderSearch.removeClass("show"), a._lHeaderSearchInput.blur(), jQuery(document).off("keydown.jabilbootstrap.header.search")
                    },
                ...
                var e, a, t, o = this,
                    ...
                    s = {
                        init: function() {
                            ...
                            }), l._lPage.off("click.jabilbootstrap.blocks"), l._lPage.on("click.jabilbootstrap.blocks", '[data-toggle="block-option"]', function(e) {
